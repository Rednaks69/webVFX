...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn("flex h-12 items-center rounded-xl border p-4", className)}
      {...props}
    />
  );
}
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-2xl px-2 py-0.75 text-sm font-medium outline-hidden select-none ",
        className,
      )}
      {...props}
    />
